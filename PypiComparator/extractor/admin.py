...
# deixei como unknow os sdks, scripts de tradução, engines,  CPython (variações como ironpython), sistema de auto complete, comandos de detecção (ex nude.py), servidor, gerador de documentação, linha de comando para acessar servidor da amazon,
